...
**TradeNote** 是一份精炼的投资交易知识手册，重点覆盖衍生品（美股期权、港股轮证、期货等）的深度策略分析、凯利公式的数学原理与实战应用，兼顾 Python 量化交易与 AI Agent 交易辅助。全笔记分为五卷共 16 章，预计约 135 页。
...
📝 **初稿完成** —— 全笔记 16 章正文已撰写完毕，18 个 Python 脚本均已通过运行测试。
...
├── TradeNote_Outline.md          # 内容完整大纲与目录
